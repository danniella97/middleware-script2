...
#The only prerequisite for running SonarQube is to have Java (Oracle JRE 11 or OpenJDK 11) 
#installed on your machine. To install OpenJDK 11, run the following commands
